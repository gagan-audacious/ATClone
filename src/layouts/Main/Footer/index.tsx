                  ...
                  <div className="footer-widget about-widget">
                    ...
                    <div className="widget-content">
                      <ul className="info-box">
                        <li>
                          <i className="far fa-map"></i>Plot No. 47, Second
                          Floor, G S Plaza, Scheme No 78 - III, Part II, Vijay
            ...
            <Col lg={6} md={12} sm={12} className="footer-column">
              ...
              <div className="footer-widget about-widget">
                ...
                <div className="widget-content">
                  <ul className="info-box">
                    <li>
                      <i className="far fa-map"></i>Plot No. 47, Second Floor, G
                      S Plaza, Scheme No 78 - III, Part II, Vijay Nagar, Indore,
        ...
        <Container>
          <div className="inner-container">
            <div className="copyright-text">
              Copyright &copy; 2022{" "}
              <Link to={AppRoutes.HOME_PAGE}> Auduacious Technology </Link> All
              rights reserved.
            </div>
