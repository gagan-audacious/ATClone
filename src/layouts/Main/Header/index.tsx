    ...
    >
      <Container>
        <div className={styles.navbarSection}>
          ...
          <Navbar.Collapse className={styles.basicNavbar} id="basic-navbar-nav">
            <Nav className={styles.navSection}>
              <Nav.Link
                as="div"
                className={styles.navLink}
                active={pathname === AppRoutes.HOME_PAGE}
              >
              ...
              <Nav.Link
                as="div"
                className={styles.navLink}
                active={pathname === AppRoutes.ABOUT}
              >
              ...
              <Nav.Link
                as="div"
                className={styles.navLink}
                active={pathname === AppRoutes.SERVICES}
              >
              ...
              <Nav.Link
                as="div"
                className={styles.navLink}
                active={pathname === AppRoutes.PROJECT}
              >
              ...
              <Nav.Link
                as="div"
                className={styles.navLink}
                active={pathname === AppRoutes.CONTACT}
              >
